  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Un problème est survenu de notre côté. Réessaie ou reviens à l'accueil.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "METZY — Plus de sorties, moins de dépenses" },
      {
        name: "description",
        content:
          "METZY réunit les meilleurs commerces de Metz : avantages exclusifs, points et récompenses.",
      },
      { property: "og:title", content: "METZY — Plus de sorties, moins de dépenses" },
      {
        property: "og:description",
        content: "Découvre les commerces autour de toi et profite d'avantages exclusifs.",
      },
